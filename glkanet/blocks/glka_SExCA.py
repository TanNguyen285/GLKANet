# glkanet/blocks/glka_SExCA.py — ĐÃ SỬA: thêm out_channels để đồng bộ API với GLKA_Shuffle
...
class GLKA_SExCA(nn.Module):
    """
    anchor = DWConv_5x5(x)
    anchor_gated = SE(anchor)                 # channel gate áp lên anchor
    branch_sum   = Σ dilated_branches(anchor)  # spatial, KHÔNG sigmoid
    out          = anchor_gated * branch_sum
    ...
    def __repr__(self) -> str:
        ...
        return (
            f"GLKA_SExCA(dim={self.dim}, out_channels={self.out_channels}, "
